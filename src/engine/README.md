...
- `engine.c`
  ...
  - Clip + track management (`engine_add_track`, `engine_remove_track`, `engine_add_clip[_to_track]`, `engine_remove_clip`, `engine_duplicate_clip`, setters for timeline/gain/name/region).
